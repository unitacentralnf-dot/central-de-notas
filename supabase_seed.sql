...
INSERT INTO public.solicitacoes_acesso (id, nome, email, obra_solicitada, mensagem, status) VALUES
('e888e8d3-5b8d-4e29-a1b7-a3f8c8d8b9e8', 'Gustavo Mendonça', 'gustavo@unita.com.br', 'Residencial Bella Vista', 'Solicito acesso ao painel financeiro desta obra para conciliação mensal.', 'pendente'),
('e999e8d3-5b8d-4e29-a1b7-a3f8c8d8b9e9', 'Aline Prado', 'aline@unita.com.br', 'Edifício Corporate Tower', 'Solicito acesso como engenheira residente para manifestação de notas.', 'pendente')
ON CONFLICT (id) DO NOTHING;
